...
Для того чтобы нужный файл запускался на расберри сразу после включения робота, у нас существует файл autostart.py. Внутри него нужно импортировать нужный файл:<br>
