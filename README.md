...
Для того чтобы нужный файл запускался на расберри сразу после включения робота, у нас существует файл autostart.py.<br> ![alt text](https://github.com/igor-k07/FE-2023-Inside/blob/main/src/autostart.PNG)
